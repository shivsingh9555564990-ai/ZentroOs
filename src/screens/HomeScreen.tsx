    ...
    >
      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        <div className="px-6 safe-area-top">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  ...
                  <defs>
                    <linearGradient id="h-bolt" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse">
          ...
          >
            <h2
              className="text-[32px] leading-[1.15] font-extrabold tracking-tight mb-3"
              style={{
                background: 'linear-gradient(135deg, #FFFFFF 0%, rgba(255,255,255,0.85) 50%, rgba(168,85,247,0.9) 100%)',
            ...
            >
              AI Growth OS{'\n'}
              <span style={{
                background: 'linear-gradient(135deg, rgba(255,255,255,0.75), rgba(168,85,247,0.8))',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
              }}>
                for Creators
          ...
          <motion.div
            className="glass rounded-2xl px-4 py-3 mb-8 flex items-center gap-3"
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-text-secondary">Systems Online</span>
            </div>
            <div className="flex-1" />
            <div className="flex items-center gap-1.5">
              <div className="w-1 h-3 rounded-full bg-accent-instagram opacity-60" />
              <div className="w-1 h-4 rounded-full bg-accent-instagram opacity-80" />
              <div className="w-1 h-3.5 rounded-full bg-accent-instagram" />
              <div className="w-1 h-5 rounded-full bg-accent-instagram opacity-70" />
              <div className="w-1 h-3 rounded-full bg-accent-instagram opacity-50" />
            </div>
            <span className="text-xs font-medium text-text-secondary ml-1.5">Active</span>
          </motion.div>
          ...
          >
            <p className="text-xs font-semibold text-text-secondary uppercase tracking-widest mb-4 px-1">
              Growth Suites
            </p>
          </motion.div>
          ...
          <AnimatedPressableCard
            ...
            borderGlowColor="rgba(255, 59, 48, 0.2)"
            onTap={() => onNavigate('youtube')}
            delay={0.45}
            className="mb-4"
          >
            <div
            ...
            <div className="relative p-5 flex items-center gap-4">
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 24px -6px rgba(255,59,48,0.2)',
                }}
              >
            ...
            <div
              className="h-px mx-5"
              style={{
                background: 'linear-gradient(90deg, rgba(255,59,48,0.3), rgba(255,59,48,0.05), transparent)',
              }}
            />
            ...
            <div className="px-5 py-3.5 flex items-center gap-4">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] text-text-secondary font-medium">6 Tools</span>
              </div>
              <div className="flex items-center gap-1.5">
          ...
          >
            ...
            <div className="relative p-5 flex items-center gap-4">
              <div
                ...
                style={{
                  ...
                  border: '1px solid rgba(168,85,247,0.2)',
                  boxShadow: '0 0 24px -6px rgba(168,85,247,0.2)',
                }}
              >
            ...
            <div
              className="h-px mx-5"
              style={{
                background: 'linear-gradient(90deg, rgba(168,85,247,0.3), rgba(236,72,153,0.1), transparent)',
              }}
            />
            ...
            <div className="px-5 py-3.5 flex items-center gap-4">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] text-text-secondary font-medium">5 Tools</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 opacity-60" />
                <span className="text-[11px] text-text-secondary font-medium">AI Powered</span>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none safe-area-bottom">
        <div className="flex justify-center pb-2 pt-4" style={{
